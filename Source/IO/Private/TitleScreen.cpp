...
UTitleScreen::UTitleScreen(const FObjectInitializer& ObjectInitializer) 
	: Super(ObjectInitializer) 
{
	...
	//QueueName = "Queue";//TextReader->ReadFile("Credentials/AWS_QueueName.txt");
...
void UTitleScreen::NativeConstruct() 
{
	...
	//JoinGameButton->OnClicked.AddDynamic(this, &UTitleScreen::JoinGame);
}

//void UTitleScreen::JoinGame() 
//{
...
//}
//
//void UTitleScreen::DescribeGameSessionQueues(const FString& QueueNameInput)
//{
//#if WITH_GAMELIFTCLIENTSDK
...
//	DescribeGameSessionQueuesRequest->OnDescribeGameSessionQueuesSuccess.AddDynamic(this, &UTitleScreen::OnDescribeGameSessionQueuesSuccess);
//	DescribeGameSessionQueuesRequest->OnDescribeGameSessionQueuesFailed.AddDynamic(this, &UTitleScreen::OnDescribeGameSessionQueuesFailed);
//	DescribeGameSessionQueuesRequest->Activate();
//#endif
//}
//
//void UTitleScreen::OnDescribeGameSessionQueuesSuccess(const TArray<FString>& FleetARNs) {
//#if WITH_GAMELIFTCLIENTSDK
...
//}
//
//void UTitleScreen::OnDescribeGameSessionQueuesFailed(const FString& ErrorMessage)
//{
//#if WITH_GAMELIFTCLIENTSDK
...
//}
//
//void UTitleScreen::SearchGameSessions(const FString& FleetId) 
//{
//#if WITH_GAMELIFTCLIENTSDK
...
//	SearchGameSessionsRequest->OnSearchGameSessionsSuccess.AddDynamic(this, &UTitleScreen::OnSearchGameSessionsSuccess);
//	SearchGameSessionsRequest->OnSearchGameSessionsFailed.AddDynamic(this, &UTitleScreen::OnSearchGameSessionsFailed);
//	SearchGameSessionsRequest->Activate();
//#endif
//}
//
//void UTitleScreen::OnSearchGameSessionsSuccess(const TArray<FString>& GameSessionIds) 
//{
//#if WITH_GAMELIFTCLIENTSDK
...
//}
//
//void UTitleScreen::OnSearchGameSessionsFailed(const FString& ErrorMessage)
//{
//#if WITH_GAMELIFTCLIENTSDK
//	GEngine->AddOnScreenDebugMessage(-1, 5.f, FColor::Red, ErrorMessage);
//	SearchGameSessionsEvent->Trigger();
...
//}
//
//void UTitleScreen::CreatePlayerSession(const FString& GameSessionId, const FString& PlayerSessionId)
//{
//#if WITH_GAMELIFTCLIENTSDK
//	UGameLiftCreatePlayerSession* CreatePlayerSessionRequest = Client->CreatePlayerSession(GameSessionId, PlayerSessionId);
//	CreatePlayerSessionRequest->OnCreatePlayerSessionSuccess.AddDynamic(this, &UTitleScreen::OnCreatePlayerSessionSuccess);
//	CreatePlayerSessionRequest->OnCreatePlayerSessionFailed.AddDynamic(this, &UTitleScreen::OnCreatePlayerSessionFailed);
//	CreatePlayerSessionRequest->Activate();
//#endif
//}
//
//void UTitleScreen::OnCreatePlayerSessionSuccess(const FString& IPAddress, const FString& Port, const FString& PlayerSessionID, const FString& PlayerSessionStatus)
//{
//#if WITH_GAMELIFTCLIENTSDK
...
//}
//
//void UTitleScreen::OnCreatePlayerSessionFailed(const FString& ErrorMessage)
//{
//#if WITH_GAMELIFTCLIENTSDK
//	GEngine->AddOnScreenDebugMessage(-1, 5.f, FColor::Red, ErrorMessage);
//	CreatePlayerSessionEvent->Trigger();
...
//}
//
//void UTitleScreen::StartGameSessionPlacement(const FString& QueueNameInput, const int& MaxPlayerCount, const FString& PlacementId)
//{
//#if WITH_GAMELIFTCLIENTSDK
...
//	StartGameSessionPlacementRequest->OnStartGameSessionPlacementSuccess.AddDynamic(this, &UTitleScreen::OnStartGameSessionPlacementSuccess);
//	StartGameSessionPlacementRequest->OnStartGameSessionPlacementFailed.AddDynamic(this, &UTitleScreen::OnStartGameSessionPlacementFailed);
//	StartGameSessionPlacementRequest->Activate();
//#endif
//}
//
//void UTitleScreen::OnStartGameSessionPlacementSuccess(const FString& GameSessionId, const FString& PlacementId, const FString& Status) 
//{
//#if WITH_GAMELIFTCLIENTSDK
...
//}
//
//void UTitleScreen::OnStartGameSessionPlacementFailed(const FString& ErrorMessage) 
//{
//#if WITH_GAMELIFTCLIENTSDK
...
//}
//
//void UTitleScreen::DescribeGameSessionPlacement(const FString& PlacementId)
//{
//#if WITH_GAMELIFTCLIENTSDK
...
//	DescribeGameSessionPlacementRequest->OnDescribeGameSessionPlacementSuccess.AddDynamic(this, &UTitleScreen::OnDescribeGameSessionPlacementSuccess);
//	DescribeGameSessionPlacementRequest->OnDescribeGameSessionPlacementFailed.AddDynamic(this, &UTitleScreen::OnDescribeGameSessionPlacementFailed);
//	DescribeGameSessionPlacementRequest->Activate();
//#endif
//}
//
//void UTitleScreen::OnDescribeGameSessionPlacementSuccess(const FString& GameSessionId, const FString& PlacementId, const FString& Status) 
//{
//#if WITH_GAMELIFTCLIENTSDK
...
//}
//
//void UTitleScreen::OnDescribeGameSessionPlacementFailed(const FString& ErrorMessage)
//{
//#if WITH_GAMELIFTCLIENTSDK
//	GEngine->AddOnScreenDebugMessage(-1, 5.f, FColor::Red, ErrorMessage);
//	DescribeGameSessionPlacementEvent->Trigger();
...
//}
//
//FString UTitleScreen::GenerateRandomId()
//{
